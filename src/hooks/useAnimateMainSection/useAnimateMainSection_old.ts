...
interface useAnimateMainSection_oldProps {
  mainSectionRef: RefObject<HTMLDivElement>;
}

function useAnimateMainSection_old({mainSectionRef}: useAnimateMainSection_oldProps) {
...
export default useAnimateMainSection_old;

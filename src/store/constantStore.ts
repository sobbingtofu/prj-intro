...
export const MY_STORIES: myStoryType[] = [
  ...
  },
  {
    ...
    content:
      "실질적이고 긍정적인 임팩트를 줄 수 있는 프로덕트에 대한 갈증은 저를 새로운 기술을 다루는 비즈니스의 집합체인 벤처캐피탈(VC), 그리고 기업의 실질적인 생존과 성장 전략을 수립하는 전략 컨설팅의 세계로 이끌었습니다.<br>그곳에서 저는 시장의 흐름을 읽는 법과 비즈니스 메커니즘을 체득하며 논리적 사고의 틀을 다졌습니다.<br>하지만 지표와 환경을 분석하는 일보다 저를 더 움직였던 것은, '이 기술이 구체적으로 사람들의 일상에 어떤 긍정적인 가치를 가져다주는가?'에 대한 물음이었습니다.<br>분석가로서 비즈니스에 제언하는 것을 넘어, **사람들의 손에 직접 닿는 가치를 설계하고 구현하고 싶다**는 확신이 들었습니다.",
  },
  {
    id: 3,
    keyWord: "Synthesis",
  ...
  },
  {
    ...
    content:
      "저는 개발 자체를 진심으로 즐기는 엔지니어이지만, 저의 시선은 단순한 코드 작성을 넘어 그 코드가 사람들에게 제공하는 **'실질적인 가치'**에 머물러 있습니다.<br>비즈니스의 목표를 명확히 이해하고, 현실적인 기술적 제약 안에서도 최선의 사용자 경험을 도출해 내는 **'프로덕트 엔지니어'**를 지향합니다.<br>사용자의 수요와 기술의 잠재 가치를 개발 요구사항으로 구체화하는 기획적 안목, 복잡한 문제를 명료하게 구조화하는 전략적 논리력, 그리고 이를 견고한 제품으로 형상화하는 엔지니어링 역량을 하나로 결합하겠습니다.<br>단순히 기능이 동작하는 것을 넘어, 제가 만든 서비스가 사람들의 일상을 더 나은 방향으로 바꾸는 것이 제가 개발자로서 이루고 싶은 목표입니다.",
  },
];

  ...
  return (
    <section id="MainSection" className="w-full h-screen overflow-auto bg-background flex items-center justify-center">
      <div className="flex-1">
        <div className="2xl:w-[1520px] w-[1200px] h-[780px] mx-auto bg-background pt-[20px] pb-[35px] px-[50px] border">
          {/* 서브텍스트 및 이미지 */}
          <div className="flex h-[180px] ml-auto justify-between items-start mr-[180px] w-[65%]">
            <div className="flex flex-col font-[400] text-[15px] tracking-[-0.02em] leading-[1.7] space-y-[-3px] ">
          ...
          {/* 헤더 텍스트 및 강조점 */}
          <div className="w-full flex items-end mt-[25px]">
            {/* 헤더 텍스트 */}
            <div
              className="flex flex-col items-end ml-auto w-[87%]
              text-[85px] tracking-[-0.02em] leading-[1.3] space-y-[-3px] font-[500]"
            >
              <h2>
          ...
          {/* 기술 카드 */}
          <div className="mt-[65px] ml-auto items-start mr-[180px] w-[65%]">

      ...
      >
        ...
        >
          ...
          <div
            ...
            2xl:w-[65%] w-[70%] 2xl:mr-[180px] xl:mr-[130px] mr-[100px] 2xl:h-[180px] h-[160px]"
          >
            <div
              className={`flex flex-col 2xl:text-[15px] xl:text-sm text-[13px]
          ...
          <div className="w-full flex items-end 2xl:mt-[25px] mt-[45px]">
            ...
            <div
              ...
              2xl:text-[85px] xl:text-[68px] text-[56px]
            ...
            >
              ...
              <h2 className="2xl:mr-[-28px] xl:mr-[-25px] mr-[-20px]">
            ...
            <div
              ...
              className={`2xl:w-[120px] 2xl:ml-[60px] xl:w-[90px] xl:ml-[40px] w-[70px] ml-[30px]
